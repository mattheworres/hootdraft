...
class UsersTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('id', 'username', 'password', 'Name', 'roles', ),
        self::TYPE_CAMELNAME     => array('id', 'username', 'password', 'name', 'roles', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_USERNAME, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_NAME, UsersTableMap::COL_ROLES, ),
        self::TYPE_FIELDNAME     => array('id', 'username', 'password', 'Name', 'roles', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('id' => 0, 'username' => 1, 'password' => 2, 'Name' => 3, 'roles' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'username' => 1, 'password' => 2, 'name' => 3, 'roles' => 4, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_USERNAME => 1, UsersTableMap::COL_PASSWORD => 2, UsersTableMap::COL_NAME => 3, UsersTableMap::COL_ROLES => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'username' => 1, 'password' => 2, 'Name' => 3, 'roles' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('username', 'username', 'VARCHAR', true, null, null);
        $this->addColumn('password', 'password', 'VARCHAR', true, null, null);
        $this->addColumn('Name', 'Name', 'VARCHAR', true, 15, '');
        $this->addColumn('roles', 'roles', 'VARCHAR', true, null, null);
    } // initialize()
