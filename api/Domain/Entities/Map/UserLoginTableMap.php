...
class UserLoginTableMap extends TableMap
{
     ...
     */
    const COL_USERID = 'user_login.UserID';
     ...
     */
    const COL_NAME = 'user_login.Name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Userid', 'Username', 'Password', 'Name', ),
        self::TYPE_CAMELNAME     => array('userid', 'username', 'password', 'name', ),
        self::TYPE_COLNAME       => array(UserLoginTableMap::COL_USERID, UserLoginTableMap::COL_USERNAME, UserLoginTableMap::COL_PASSWORD, UserLoginTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('UserID', 'Username', 'Password', 'Name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Userid' => 0, 'Username' => 1, 'Password' => 2, 'Name' => 3, ),
        self::TYPE_CAMELNAME     => array('userid' => 0, 'username' => 1, 'password' => 2, 'name' => 3, ),
        self::TYPE_COLNAME       => array(UserLoginTableMap::COL_USERID => 0, UserLoginTableMap::COL_USERNAME => 1, UserLoginTableMap::COL_PASSWORD => 2, UserLoginTableMap::COL_NAME => 3, ),
        self::TYPE_FIELDNAME     => array('UserID' => 0, 'Username' => 1, 'Password' => 2, 'Name' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UserLoginTableMap::COL_USERID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(UserLoginTableMap::COL_USERID) && $criteria->keyContainsValue(UserLoginTableMap::COL_USERID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.UserLoginTableMap::COL_USERID.')');
        }
