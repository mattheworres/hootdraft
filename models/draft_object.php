...
class draft_object {
  ...
  public function checkDraftPublicLogin() {
    ...
    return isset($_SESSION['did']) && isset($_SESSION['draft_password']) && $_SESSION['did'] == $this->draft_id && $_SESSION['draft_password'] == $this->draft_password;
  }
  ...
  public static function checkStatus($status) {
    if ($status == "undrafted" || $status == "in_progress" || $status == "complete")
      return true;
    else
      return false;
  }
