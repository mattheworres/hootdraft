...
/**
 * Represents a round time object.
 *
 * A round time can be specified once for all rounds of a draft, specifically for each round, or not specified at all for a draft (not using the timer)
 */
class round_time_object {
