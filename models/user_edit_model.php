  ...
  public function getFormValues() {
    ...
    if (isset($_POST['old_password'])) {
      ...
      if (isset($_POST['new_password']))
        $this->newPassword = user_object::getHashedPassword($_POST['new_password']);
      if (isset($_POST['verify_password']))
        $this->newVerifiedPassword = user_object::getHashedPassword($_POST['verify_password']);
    }
    if (isset($_POST['name']))
      $this->public_name = $_POST['name'];
  }
