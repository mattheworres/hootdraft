...
if(DRAFT_ID > 0) {
	?><div id="right_side">
	<h3>Navigation</h3>
	<p><a href="control_panel.php?action=manageDrafts"><span style="display: inline-block; vertical-align: middle; margin-right: 2px;" class="ui-icon ui-icon-circle-arrow-w"></span>Select a Draft</span></a></p>
