...
if(DRAFT_ID > 0) {
	...
	<?php if(!$DRAFT->isUndrafted()) { ?><p><a href="comm_draft_room.php?draft_id=<?php echo DRAFT_ID; ?>"><span style="display: inline-block; vertical-align: middle; margin-right: 2px;" class="ui-icon ui-icon-circle-check"></span>Enter the Draft Room</a></p><?php } ?>
