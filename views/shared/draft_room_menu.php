...
if(DRAFT_ID > 0) {
	...
	<p><a href="public_draft.php?action=draftBoard&draft_id=<?php echo DRAFT_ID; ?>"><span style="display: inline-block; vertical-align: middle; margin-right: 2px;" class="ui-icon ui-icon-calculator"></span>View Public Board</a></p>
