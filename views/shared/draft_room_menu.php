...
if(DRAFT_ID > 0) {
	...
	<p><a href="trades.php?did=<?php echo DRAFT_ID; ?>"><span style="display: inline-block; vertical-align: middle; margin-right: 2px;" class="ui-icon ui-icon-transferthick-e-w"></span>Enter a Trade</a></p>
